...
std::shared_ptr<CamPinHole> CreateCamPinHole_PINHOLE_GPU(vk_utils::VulkanContext a_ctx, size_t a_maxThreadsGenerated) 
{ 
...
void CamPinHole_PINHOLE_GPU::InitVulkanObjects(VkDevice a_device, VkPhysicalDevice a_physicalDevice, size_t a_maxThreadsCount) 
{
...
void CamPinHole_PINHOLE_GPU::UpdatePlainMembers(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)
{
...
void CamPinHole_PINHOLE_GPU::ReadPlainMembers(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)
{
...
void CamPinHole_PINHOLE_GPU::UpdateVectorMembers(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)
{
  if(m_cie_x.size() > 0)
...
void CamPinHole_PINHOLE_GPU::ContribSampleCmd(int in_blockSize, const float* in_color, float* out_color, int subPassId)
{
  uint32_t blockSizeX = 256;
  uint32_t blockSizeY = 1;
  uint32_t blockSizeZ = 1;
...
void CamPinHole_PINHOLE_GPU::copyKernelFloatCmd(uint32_t length)
{
...
VkBufferMemoryBarrier CamPinHole_PINHOLE_GPU::BarrierForClearFlags(VkBuffer a_buffer)
{
...
VkBufferMemoryBarrier CamPinHole_PINHOLE_GPU::BarrierForSingleBuffer(VkBuffer a_buffer)
{
  VkBufferMemoryBarrier bar = {};
  bar.sType               = VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER;
  bar.pNext               = NULL;
...
void CamPinHole_PINHOLE_GPU::BarriersForSeveralBuffers(VkBuffer* a_inBuffers, VkBufferMemoryBarrier* a_outBarriers, uint32_t a_buffersNum)
{
...
void CamPinHole_PINHOLE_GPU::AddSamplesContributionBlockCmd(VkCommandBuffer a_commandBuffer, float* out_color4f, const float* colors4f, uint32_t in_blockSize, uint32_t a_width, uint32_t a_height, int subPassId)
{
...
void CamPinHole_PINHOLE_GPU::AddSamplesContributionBlock(float* out_color4f, const float* colors4f, uint32_t in_blockSize, uint32_t a_width, uint32_t a_height, int subPassId)
{
...
void CamPinHole_PINHOLE_GPU::GetExecutionTime(const char* a_funcName, float a_out[4])
{
