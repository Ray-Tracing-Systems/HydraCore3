...
enum MATERIAL_TYPES { MAT_TYPE_GLTF          = 1,
                      ...
                      //NEURAL MATERIALS
                      MAT_TYPE_NEURAL_BRDF   = 0x10000000,
                      MAT_TYPE_KANBRDF       = 0x10000001,
...
static constexpr uint NBRDF_WEIGTHSIDX     = 0;
static constexpr uint NBRDF_MEDIANIDX      = 1;
static constexpr uint NBRDF_ALPHA          = 0;

static constexpr uint KANBRDF_WEIGTHSIDX   = 0;
static constexpr uint KANBRDF_ALPHA        = 1;
