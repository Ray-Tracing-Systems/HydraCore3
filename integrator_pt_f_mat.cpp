...
BsdfSampleN Integrator::MaterialSampleAndEvalN(uint a_materialId, uint tid, uint bounce, SpecN *wavelengths, RandomGen* a_gen, float3 v, float3 n, float3 tan, float2 tc, 
                                             MisData* a_misPrev, const uint a_currRayFlags)
{
  BsdfSample res;
  {
...
BsdfEvalN Integrator::MaterialEvalN(uint a_materialId, SpecN *wavelengths, float3 l, float3 v, float3 n, float3 tan, float2 tc)
{
  BsdfEvalN res;
  {
    res.val = float4(0,0,0,0);
