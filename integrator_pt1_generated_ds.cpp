...
void Integrator_Generated::AllocateAllDescriptorSets()
{
  ...
  buffersSize.descriptorCount          = 106 + 64; // + 64 for reserve
...
VkDescriptorSetLayout Integrator_Generated::CreateCastSingleRayMegaDSLayout()
{
  ...
  // binding for m_textures
  dsBindings[12].binding            = 12;
  dsBindings[12].descriptorType     = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
  m_vdata.m_texturesArrayMaxSize = m_textures.size();
  if(m_vdata.m_texturesArrayMaxSize == 0)
    m_vdata.m_texturesArrayMaxSize = GetDefaultMaxTextures();
  dsBindings[12].descriptorCount    = m_vdata.m_texturesArrayMaxSize;
  dsBindings[12].stageFlags         = VK_SHADER_STAGE_COMPUTE_BIT;
  dsBindings[12].pImmutableSamplers = nullptr;
...
VkDescriptorSetLayout Integrator_Generated::CreateNaivePathTraceMegaDSLayout()
{
  ...
  // binding for m_pAccelStruct
  dsBindings[10].binding            = 10;
  dsBindings[10].descriptorType     = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
  dsBindings[10].descriptorCount    = 1;
  dsBindings[10].stageFlags         = VK_SHADER_STAGE_COMPUTE_BIT;
  dsBindings[10].pImmutableSamplers = nullptr;
...
void Integrator_Generated::InitAllGeneratedDescriptorSets_RayTrace()
{
  ...
  //
  // descriptor set #0: RayTraceMegaCmd (["out_color","m_matIdByPrimId","m_vNorm4f","m_vTang4f","m_allRemapLists","m_precomp_coat_transmittance","m_spec_offset_sz","m_pAccelStruct","m_lights","m_remapInst","m_vertOffset","m_spec_values","m_packedXY","m_textures","m_triIndices","m_materials","m_matIdOffsets","m_allRemapListsOffsets","m_normMatrices"])
  {
...
void Integrator_Generated::InitAllGeneratedDescriptorSets_CastSingleRay()
{
  // now create actual bindings
  //
  // descriptor set #1: CastSingleRayMegaCmd (["out_color","m_vNorm4f","m_vTang4f","m_allRemapListsOffsets","m_lights","m_allRemapLists","m_precomp_coat_transmittance","m_materials","m_remapInst","m_vertOffset","m_spec_values","m_packedXY","m_textures","m_triIndices","m_spec_offset_sz","m_pAccelStruct","m_matIdByPrimId","m_matIdOffsets"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[7].buffer = m_vdata.m_materialsBuffer;
    descriptorBufferInfo[7].offset = m_vdata.m_materialsOffset;
    ...
    descriptorBufferInfo[9]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[9].buffer = m_vdata.m_vertOffsetBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_vertOffsetOffset;
    descriptorBufferInfo[9].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[9]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[9].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[16]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[16].buffer = m_vdata.m_matIdByPrimIdBuffer;
    descriptorBufferInfo[16].offset = m_vdata.m_matIdByPrimIdOffset;
    descriptorBufferInfo[16].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[16]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[16].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
...
void Integrator_Generated::InitAllGeneratedDescriptorSets_PackXY()
{
  // now create actual bindings
  //
  // descriptor set #2: PackXYMegaCmd (["m_textures","m_spec_values","m_remapInst","m_materials","m_spec_offset_sz","m_precomp_coat_transmittance","m_packedXY","m_lights","m_allRemapLists","m_allRemapListsOffsets"])
  {
    constexpr uint additionalSize = 1;
...
void Integrator_Generated::InitAllGeneratedDescriptorSets_PathTraceFromInputRays()
{
  // now create actual bindings
  //
  // descriptor set #3: PathTraceFromInputRaysMegaCmd (["in_rayPosAndNear","in_rayDirAndFar","out_color","m_matIdByPrimId","m_randomGens","m_vNorm4f","m_vTang4f","m_triIndices","m_allRemapLists","m_precomp_coat_transmittance","m_spec_offset_sz","m_pAccelStruct","m_lights","m_remapInst","m_vertOffset","m_spec_values","m_instIdToLightInstId","m_textures","m_materials","m_matIdOffsets","m_allRemapListsOffsets","m_normMatrices"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[9]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[9].buffer = m_vdata.m_precomp_coat_transmittanceBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_precomp_coat_transmittanceOffset;
    descriptorBufferInfo[9].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[9]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[9].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
...
void Integrator_Generated::InitAllGeneratedDescriptorSets_PathTrace()
{
  // now create actual bindings
  //
  // descriptor set #4: PathTraceMegaCmd (["out_color","m_cie_x","m_matIdByPrimId","m_randomGens","m_vNorm4f","m_vTang4f","m_triIndices","m_allRemapLists","m_precomp_coat_transmittance","m_cie_z","m_materials","m_remapInst","m_vertOffset","m_spec_values","m_packedXY","m_textures","m_instIdToLightInstId","m_spec_offset_sz","m_pAccelStruct","m_lights","m_matIdOffsets","m_cie_y","m_allRemapListsOffsets","m_normMatrices"])
  {
    constexpr uint additionalSize = 1;
...
void Integrator_Generated::InitAllGeneratedDescriptorSets_NaivePathTrace()
{
  // now create actual bindings
  //
  // descriptor set #5: NaivePathTraceMegaCmd (["out_color","m_cie_x","m_matIdByPrimId","m_randomGens","m_vNorm4f","m_vTang4f","m_triIndices","m_allRemapLists","m_precomp_coat_transmittance","m_spec_offset_sz","m_pAccelStruct","m_lights","m_remapInst","m_vertOffset","m_spec_values","m_instIdToLightInstId","m_packedXY","m_textures","m_cie_z","m_materials","m_matIdOffsets","m_cie_y","m_allRemapListsOffsets","m_normMatrices"])
  {
    constexpr uint additionalSize = 1;
    ...
    descriptorBufferInfo[9]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[9].buffer = m_vdata.m_spec_offset_szBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_spec_offset_szOffset;
    descriptorBufferInfo[9].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[9]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[9].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
...

    {
      ...
      accelStructs       [10] = pScene->GetSceneAccelStruct();
      descriptorAccelInfo[10] = {VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR,VK_NULL_HANDLE,1,&accelStructs[10]};
    }
    writeDescriptorSet[10]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[10].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    writeDescriptorSet[10].dstBinding       = 10;
    writeDescriptorSet[10].descriptorCount  = 1;
    writeDescriptorSet[10].descriptorType = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
    writeDescriptorSet[10].pNext          = &descriptorAccelInfo[10];
    ...
    descriptorBufferInfo[14]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[14].buffer = m_vdata.m_spec_valuesBuffer;
    descriptorBufferInfo[14].offset = m_vdata.m_spec_valuesOffset;
    descriptorBufferInfo[14].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[14]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[14].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[15]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[15].buffer = m_vdata.m_instIdToLightInstIdBuffer;
    descriptorBufferInfo[15].offset = m_vdata.m_instIdToLightInstIdOffset;
    descriptorBufferInfo[15].range  = VK_WHOLE_SIZE;  
    writeDescriptorSet[15]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[15].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
